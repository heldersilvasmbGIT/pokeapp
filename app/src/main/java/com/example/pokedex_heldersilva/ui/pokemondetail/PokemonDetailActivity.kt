...
import com.example.pokedex_heldersilva.adapter.PokemonAbilityListAdapter
import com.example.pokedex_heldersilva.adapter.PokemonMoveListAdapter
...
import com.example.pokedex_heldersilva.ui.pokemonlist.KEY_NAME
...
class PokemonDetailActivity : BaseActivity(), PokemonDetailView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = PokemonDetailPresenterImpl(this, PokemonDetailConnectorImpl())
